...
if ! cd ${outputdir}; then
        ...
        if [ $num == 0 ]; then
                ...
                echo "Attempting refseq taxid lookup.";
                #TODO: if "refseq" is in the name, or by default, call my python script instead
                python ${d}/add_taxids.py ${inputfile} ${outfile_annotate}
